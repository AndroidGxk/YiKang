...
public class YoushengActivity extends BaseActivtiy {
    ...
    protected void initView() {
        ...
        if (http == null) {
            http = "https://www.yikch.com/mobile/appShow/yousheng?type=android";
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("/appShow/proDetail")) {
                    Intent intent = new Intent(YoushengActivity.this, ParticularsActivity.class);
                    if (getLogUser(BaseApp.getApp()) != null) {
                    ...
                    Intent intent = new Intent(YoushengActivity.this, H5RecommendListActivity.class);
                    intent.putExtra("http", url);
                    startActivity(intent);
                    return true;
                } else if (url.contains("discounts")) {
                    //优惠券链接
                    Intent intent = new Intent(YoushengActivity.this, H5DiscountActivity.class);
                    intent.putExtra("http", url);
                    intent.putExtra("none", "yes");
                    startActivity(intent);
                    return true;
                } else if (url.contains("appShow/orderLogistics")) {
                    Intent intent = new Intent(YoushengActivity.this, H5WuliuZhuangtaiActivity.class);
                    intent.putExtra("http", url);
                    startActivity(intent);
                    return true;
...
//                    title_text.setText("签到");
                    Intent intent = new Intent(YoushengActivity.this, YoushengActivity.class);
                    intent.putExtra("http", "https://www.yikch.com/mobile/appShow/checkIn?type=android&userId=" + getLogUser(YoushengActivity.this).getId() + "");
