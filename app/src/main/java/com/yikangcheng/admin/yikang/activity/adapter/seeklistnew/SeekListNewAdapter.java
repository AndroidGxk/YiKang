 ...
 */
public class SeekListNewAdapter extends RecyclerView.Adapter<SeekListNewAdapter.Vh> {

    List<ClassifyCommodityListBean.CommodityListBean> listBeanList = new ArrayList<>();
    Context context;

    public SeekListNewAdapter(Context context) {
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.seeklistitem_new, parent, false);
        return new Vh(view);
    }
    ...
    public void onBindViewHolder(@NonNull Vh vh, final int position) {
        ...
        vh.good_marprice.setText("市场价:¥" + commodityListBean.getSourceprice());
        vh.good_buynum.setText(commodityListBean.getBuycount() + "人已购买");
