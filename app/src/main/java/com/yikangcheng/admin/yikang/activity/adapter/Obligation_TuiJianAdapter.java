 ...
 * WF
 */
public class Obligation_TuiJianAdapter extends RecyclerView.Adapter {
    private final ArrayList<RecommendBean> mList;
    private final ObligationActivity mContent;

    public Obligation_TuiJianAdapter(ArrayList<RecommendBean> recommendBeans, ObligationActivity obligationActivity) {
