 ...
 * 删除用户地址
 */
public class WelfareCoursePresenter extends BasePresenter {
    public WelfareCoursePresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.welfareCoursePopup((int) args[0], (int) args[1]);
    }
}
