...
public class UpdateCountPresenter extends BasePresenter {

    public UpdateCountPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.updateBuyNum((int) args[0], (int) args[1], (int) args[2]);
    }
}
