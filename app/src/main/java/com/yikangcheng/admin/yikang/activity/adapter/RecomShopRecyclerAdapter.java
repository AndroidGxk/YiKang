...
public class RecomShopRecyclerAdapter extends RecyclerView.Adapter<RecomShopRecyclerAdapter.Vh> {
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recom_shop_recycler_item, parent, false);
        return new Vh(view);
    }
