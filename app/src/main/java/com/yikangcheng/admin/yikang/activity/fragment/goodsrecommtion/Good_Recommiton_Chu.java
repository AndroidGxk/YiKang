 ...
 * 厨卫
 */
public class Good_Recommiton_Chu extends BaseFragment implements ICoreInfe {
    ...
    protected void initView(View view) {
        ...
        homeFragment.setChildObjectForPosition(view,2);
    }

    @Override
    protected void initData() {
        recommendPresenter.request(10, 110);
    ...
    protected int getFragmentLayoutId() {
        return R.layout.good_recommiton_recycler_three;
    }
