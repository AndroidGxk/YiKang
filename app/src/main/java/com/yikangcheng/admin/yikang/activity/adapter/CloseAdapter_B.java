 ...
 * WF
 */
public class CloseAdapter_B extends RecyclerView.Adapter {
    private final Context mContent;
    private final List<CloseBean.OrderBean.OrderDetailsListBean> mList = new ArrayList<>();
    private OnClickListener mListener;

    public CloseAdapter_B(Context content) {
    ...
    public void addAll(List<CloseBean.OrderBean.OrderDetailsListBean> mList) {
