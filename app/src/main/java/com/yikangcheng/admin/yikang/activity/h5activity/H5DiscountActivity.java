...
public class H5DiscountActivity extends BaseActivtiy {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.toString().contains("sina.cn")) {
                    webView.loadUrl("https://www.yikch.com/mobile/appShow/discounts?type=android&userId=" + loginBean.getId() + "");
                    return true;
                }
                return false;
            }
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("/appShow/proDetail")) {
                    Intent intent = new Intent(H5DiscountActivity.this, ParticularsActivity.class);
                    ...
                    finish();
                    return true;
                } else if (url.contains("appShow/discounts")) {
                    webView.loadUrl("https://www.yikch.com/mobile/appShow/discounts?type=android&userId=" + loginBean.getId() + "");
                    return true;
                    ...
                    startActivity(intent);
                    return true;
                } else if (url.contains("mobile/appShow/yousheng")) {
