 ...
 * 删除用户地址
 */
public class WelfareCourseListPresenter extends BasePresenter {
    public WelfareCourseListPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.welfareCoursePopupList((int) args[0], (int) args[1]);
    }
}
