...
public class SlideView extends View {
    ...
    private void initView() {
        ...
        mBound = new Rect();
        backgroundColor = getResources().getColor(R.color.colorTextF);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < CityActivity.pinyinList.size(); i++) {
            ...
            if (i == position - 1) {
                paint.setColor(getResources().getColor(R.color.colorTextT));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (isSlide) {
                    backgroundColor = getResources().getColor(R.color.colorTextT);
                    mTextHeight = mHeight / CityActivity.pinyinList.size();
