 ...
 * WF
 */
public class HaveSignPresenter extends BasePresenter {
    public HaveSignPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.orderAto((int) args[0], (int) args[1], (String) args[2]);
    }
}
