 ...
 * 启动页广告
 */
public class SectionImagePresenter extends BasePresenter {
    public SectionImagePresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.querysectionImages((int) args[0]);
    }
}
