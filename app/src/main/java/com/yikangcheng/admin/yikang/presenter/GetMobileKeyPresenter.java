...
public class GetMobileKeyPresenter extends BasePresenter {

    public GetMobileKeyPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.getMobileKey((String) args[0], (String) args[1]);
    }
}
