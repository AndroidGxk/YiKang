 ...
 * WF
 */
public class payWaitSignPresenter extends BasePresenter {
    public payWaitSignPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.payOkWaitSign((int) args[0], (int) args[1], (String) args[2]);
    }
}
