...
public class AfterSaleStatusPresenter extends BasePresenter {

    public AfterSaleStatusPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.afterSaleStatus((int) args[0], (int) args[1]);
    }
}
