 ...
 * 新版已完成订单详细页面
 */
public class OrderAccomActivity extends BaseActivtiy implements ICoreInfe {
    ...
    public void onClickListener() {
         ...
         * 进入商品详情页
         */
        accomAdapter.setOnGoPariAccomClickListener(new OrderAccomAdapter.onGoPariAccomClickListener() {
            @Override
            public void onClick(int goodId) {
                Intent intent = new Intent(OrderAccomActivity.this, ParticularsActivity.class);
         ...
         * 再次购买
         */
        accomAdapter.setOnBuyGoodAccomListener(new OrderAccomAdapter.onBuyGoodAccomListener() {
            @Override
...
//                addShopPresenter.request(getLogUser(OrderAccomActivity.this).getId(), String.valueOf(goodId), "COMMODITY", String.valueOf(buyNum), String.valueOf(buyNum));
            }
        });
        /**
         * 点击售后
         */
        accomAdapter.setOnAfterListener(new OrderAccomAdapter.onAfterListener() {
            @Override
            public void onClick(int id) {
                Intent intent = new Intent(OrderAccomActivity.this, SeleGoodActivity.class);
        ...
        kefu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SobotApi.setCustomRobotHelloWord(OrderAccomActivity.this, "您好，易康成客服很高兴为您服务，请问有什么可以帮助您的？");
                SobotApi.startSobotChat(OrderAccomActivity.this, info);
            }
        });
    ...
    protected void initEventData() {
        ...
        recycle.setAdapter(accomAdapter);
        //解决滑动不流畅
    ...
    protected int getActivtiyLayoutId() {
        return R.layout.activity_order_accom;
    }
            ...
            if (request.isSuccess()) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(OrderAccomActivity.this, PartiCarActivity.class));
                    }
                }, 1000);
            }
        }
