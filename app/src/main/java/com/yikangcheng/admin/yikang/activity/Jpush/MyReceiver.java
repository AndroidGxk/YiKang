...
public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            url = bundle.getString("cn.jpush.android.ALERT");
            value = bundle.getString("cn.jpush.android.EXTRA");
            Log.d("GTT", url);
            Log.d("GTT", value);
