...
public class FirstSeckillRecyclerAdapter extends RecyclerView.Adapter<FirstSeckillRecyclerAdapter.Vh> {
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.first_seckill_recycler_item, parent, false);
        return new Vh(view);
    }
