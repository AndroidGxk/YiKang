package com.yikangcheng.admin.yikang.activity.Jpush;
...
public class LingyuanActivity extends BaseActivtiy {
...
//        title_text.setTextColor(Color.parseColor());
        ...
        if (http == null) {
            http = "https://www.yikch.com/mobile/appShow/zeroPurchase?type=android";
            title_text.setText("专场0元购");
        }
        if (none != null) {
            if (none.equals("yes")) {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.toString().contains("sina.cn")) {
                    webview.loadUrl(http+"&userId="+getLogUser(LingyuanActivity.this).getId());
                    return true;
                }
                return false;
            }
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("/appShow/proDetail")) {
                    Intent intent = new Intent(LingyuanActivity.this, ParticularsActivity.class);
                    ...
                    Intent intent = new Intent(LingyuanActivity.this, H5RecommendListActivity.class);
                    intent.putExtra("http", url);
                    startActivity(intent);
                    return true;
                } else if (url.contains("discounts")) {
                    //优惠券链接
                    Intent intent = new Intent(LingyuanActivity.this, H5DiscountActivity.class);
                    intent.putExtra("http", url);
                    intent.putExtra("none", "yes");
                    startActivity(intent);
                    return true;
                } else if (url.contains("appShow/orderLogistics")) {
                    Intent intent = new Intent(LingyuanActivity.this, H5WuliuZhuangtaiActivity.class);
                    intent.putExtra("http", url);
                    startActivity(intent);
                    return true;
...
//                    title_text.setText("签到");
                    Intent intent = new Intent(LingyuanActivity.this, LingyuanActivity.class);
                    intent.putExtra("http", "https://www.yikch.com/mobile/appShow/checkIn?type=android&userId=" + getLogUser(LingyuanActivity.this).getId() + "");
