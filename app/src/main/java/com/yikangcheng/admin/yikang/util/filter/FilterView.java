package com.yikangcheng.admin.yikang.util.filter;
...
public class FilterView extends LinearLayout {
    int expandedIcon = R.drawable.xia;
    int collapseIcon = R.drawable.xia;
    ...
    public FilterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            if (array.hasValue(R.styleable.FilterView_textSize2)) {
                txtName.setTextSize(array.getDimension(R.styleable.FilterView_textSize2, 14));
            }
