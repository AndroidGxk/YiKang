 ...
 */
public class CateAddressMeiRecyclerAdapterTwo extends RecyclerView.Adapter<CateAddressMeiRecyclerAdapterTwo.Vh> {
    //记录下标
    ...
    public CateAddressMeiRecyclerAdapterTwo(Context context) {
