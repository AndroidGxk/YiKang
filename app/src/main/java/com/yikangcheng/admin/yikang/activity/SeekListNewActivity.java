 ...
 * 搜索列表页面
 */
public class SeekListNewActivity extends BaseActivtiy implements ICoreInfe, View.OnClickListener {

    private TextView edit_seek_sousuo;
    private CommodityPresenter commodityPresenter;
    private RecyclerView xrecycler;
    private SeekListNewAdapter classCommodAdapter;
    ...
    protected void initView() {
        ...
        classCommodAdapter.setOnClickLisetener(new ClassCommodAdapter.onClickLisetener() {
            ...
            public void onclick(int id) {
                Intent intent1 = new Intent(SeekListNewActivity.this, ParticularsActivity.class);
    ...
    protected void initEventData() {
        ...
        edit_seek_sousuo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SeekListNewActivity.this, SeekActivity.class));
                finish();
            }
        });
        /**
    ...
    protected int getActivtiyLayoutId() {
        return R.layout.activity_seek_list_new;
    }
