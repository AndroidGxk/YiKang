 ...
 * WF
 */
public class DiscountKeyongPresenter extends BasePresenter {
    public DiscountKeyongPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.DiscountCouponUnused((int) args[0]);
    }
}
