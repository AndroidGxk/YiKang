...
public class AwaitAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == 1) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_new_one_recycler_item_fukuan, parent, false);
            return new DVhOne(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_new_recycler_item_fukuan, parent, false);
            return new DVh(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder vh, final int position) {
        ...
        if (vh instanceof DVhOne) {
            ...
            ((DVhOne) vh).yellow_text.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (onPayClickListener != null) {
                        onPayClickListener.onClick(mList.get(position).getOrderId(), position);
                    }
                }
            });
            ...
            AwaitAdapter_B all_b_adapter = new AwaitAdapter_B(mContext);
            ...
            all_b_adapter.setOnGoParicListener(new AwaitAdapter_B.onGoParicListener() {
                @Override
    ...
    public void setOnPayClickListener(AwaitAdapter.onPayClickListener onPayClickListener) {
    ...
    public void setOnPartiCliclListener(AwaitAdapter.onPartiCliclListener onPartiCliclListener) {
