...
public class SerachUtils {
    ...
    public List<String> getSearchList() {
        String history = SharedPreferencesUtil.get(BaseApp.getApp(), KEY);
    ...
    public void saveFile(List<String> list) {
        ...
        if (list != null && list.size() > 0) {
            ...
            SharedPreferencesUtil.add(BaseApp.getApp(), KEY, history);
        }
    }
    ...
    public void clear() {
        searchHistory.clear();
        SharedPreferencesUtil.delete(BaseApp.getApp(), KEY);
    }
}
