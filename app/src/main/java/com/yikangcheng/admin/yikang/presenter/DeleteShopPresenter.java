 ...
 * 删除用户地址
 */
public class DeleteShopPresenter extends BasePresenter {
    public DeleteShopPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.deleteShopCar((int) args[0], (String) args[1]);
    }
}
