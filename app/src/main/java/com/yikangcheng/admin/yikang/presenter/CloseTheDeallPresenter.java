 ...
 * WF
 */
public class CloseTheDeallPresenter extends BasePresenter {
    public CloseTheDeallPresenter(ICoreInfe dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.CloseTheDealBean((int) args[0]);
    }
}
