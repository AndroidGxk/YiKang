 ...
 * Describe:网络请求工具类
 */
public class NotWorkIntranetUtils {
    private static NotWorkIntranetUtils instance;
    private Retrofit retrofit;

    private NotWorkIntranetUtils(){
        init();
    }

    public static NotWorkIntranetUtils getInstance() {
        if (instance == null){
            instance = new NotWorkIntranetUtils();
        }
        return instance;
    }
