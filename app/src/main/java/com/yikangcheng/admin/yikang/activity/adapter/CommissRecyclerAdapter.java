...
public class CommissRecyclerAdapter extends RecyclerView.Adapter<CommissRecyclerAdapter.Vh> {
    List<DiscountBean.CouponCodeListBean> stringList = new ArrayList<>();
    //记录下标
    private int mPosition;
    Context context;

    public CommissRecyclerAdapter(Context context) {
        this.context = context;
    }

    public void addAll(List<DiscountBean.CouponCodeListBean> stringList) {
    ...
    public void onBindViewHolder(@NonNull Vh vh, final int position) {
        DiscountBean.CouponCodeListBean couponCodeListBean = stringList.get(position);
        DiscountBean.CouponCodeListBean.CouponBean coupon = couponCodeListBean.getCoupon();
